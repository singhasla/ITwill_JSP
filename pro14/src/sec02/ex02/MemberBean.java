...
//VO역할이란?
//1.DB의 테이블에서 조회한 레코드의 컬럼 값들을  아래의 MemberBean클래스의 각 변수에 저장 하거나 
//2.회원 가입 창에서 입력한 회원 정보들을  DB에 추가 시키기 전에 임시로 각변수에 저장 시켜~~~~
//  new MemberBean객체를 생성하여 DB에 한번에 추카시켜 주기 위해 제공 해주는 클래스 
...
//   DB에 INSERT시  new MemberBean();객체 단위로  추가시킬수 있다.
