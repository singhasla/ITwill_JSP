...
<body>
	<h1>login2.html의 요청을 받아 클라이언트의 웹브라우저에 응답해주는 result2.jsp페이지</h1>
	<%
		// 1. login2.html에서 입력한 아이디와 비밀번호가 한글이 존재하면 한글이 깨지므로
		//		request내장객체 영역에 인코딩방식을 UTF-8방식으로 지정하자.
		//한글처리
		request.setCharacterEncoding("utf-8");
	
		// 2. login2.html에서 입력하여 요청한 요청값 얻기
	...
	%>
		아이디를 입력하세요. <br>
		<a href="/pro12/result2.html">로그인하기</a>
	<%
		}else{	//아이디를 입력했다면?
	%>
