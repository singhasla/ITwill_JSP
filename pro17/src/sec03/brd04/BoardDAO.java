...
public class BoardDAO {
	...
	public int insertNewArticle(ArticleVO article){
		...
		return articleNO; //DB에 INSERT 시킬 새 글의 글 번호를 리턴
	...
	//매개변수로 전달받은 글번호를 이용해 글을 조회한 후 반환
	public ArticleVO selectArticle(int articleNO) {
		...
		try {
			...
			//매개변수로 전달받은 글번호에 해당되느 글의 정보를 검색하는 SQL문 만들기
			...
			//각 변수에 저장된 조회한 글 정보를 위에 생성된 ArticleVO객체의 각 변수에 저장
		...
		return articleVO;	//BoardService클래스의 43번째줄로 다시 반환
