...
public class BoardService {
	...
	//컨트롤러로부터 전달받은 글번호를 다시 BoardDAO객체의 selectArticle()메소드를 호출해 글정보를 검색해 옴
	public ArticleVO viewArticle(int articleNO) {

		//검색(조회)한 글정보를 저장할 ArticleVO객체를 담을 변수 선언
		ArticleVO article = null;
		//글번호에 해당되는 글을 조회하여 ArticleVO객체의 각 변수에 저장후 ArticleVO객체를 리턴 받음
