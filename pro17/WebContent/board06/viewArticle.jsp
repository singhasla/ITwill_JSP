...
<head>
   ...
   <script type="text/javascript" >
	 ...
	 //답글쓰기 버튼 클릭했을때 호출되는 함수로
	 //답글을 작성하는 페이지로 이동할 주소값과, 답글을 작성하기 위해 주글의 글번호를 매개변수로 전달받는다.
	 function fn_reply_form(url, parentNO) {
		 
		var form = document.createElement("form");
		//<form method="post" action="${contextPath}/board/replyForm.do"> </form>
		form.setAttribute("method", "post");
		form.setAttribute("action", url);
		...
		//<form>태그를 이용해 BoardController서블릿으로 답글 작성하는 화면으로 이동시켜줘~라는 요청(전송)을 한다
		form.submit();		
